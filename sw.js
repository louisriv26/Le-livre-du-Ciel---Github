const VERSION = 'ldc-v2.18.1-R1B';
const CACHE_PREFIX = 'ldc-le-livre-du-ciel-';
const SHELL_CACHE = `${CACHE_PREFIX}shell-v2.18.1-R1B`;
const RUNTIME_CACHE = `${CACHE_PREFIX}runtime-v2.18.1-R1B`;
const OFFLINE_CACHE = 'ldc-le-livre-du-ciel-offline-v2.18.1-R1B';
const OFFLINE_MANIFEST_URL = './offline_manifest.json';
const OFFLINE_MANIFEST_SCHEMA = 'ldc-offline-manifest-v2';
const OFFLINE_CONTENT_BINDING = '32360e1ae2ae96f8924360420b378eb579b96ea4a21c70b36960ad06decdc851';
...
async function loadOfflineManifest() {
  ...
  if(m.schema!==OFFLINE_MANIFEST_SCHEMA||m.app_version!=='v2.18.1-R1B'||m.cache_version!==OFFLINE_CACHE)throw new Error('offline manifest incompatible');
