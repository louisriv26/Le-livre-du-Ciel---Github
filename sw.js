const VERSION = 'ldc-v2.19.56-R1B';
const CACHE_PREFIX = 'ldc-le-livre-du-ciel-';
const SHELL_CACHE = `${CACHE_PREFIX}shell-v2.19.56-R1B`;
const RUNTIME_CACHE = `${CACHE_PREFIX}runtime-v2.19.56-R1B`;
const OFFLINE_CACHE = 'ldc-le-livre-du-ciel-offline-v2.19.56-R1B';
const OFFLINE_MANIFEST_URL = './offline_manifest.json';
const OFFLINE_MANIFEST_SCHEMA = 'ldc-offline-manifest-v2';
const OFFLINE_CONTENT_BINDING = '14f487831d859058a92b36b59bb539f07a7a238a319a4d157a16dae1271a6ab1';
const OFFLINE_CORPUS_MANIFEST_SHA256 = '03d81ca4df67e3b198ad32b22acae08c54cfcb345fe3871d253c86389a7104c5';
...
async function loadOfflineManifest() {
  ...
  if(m.schema!==OFFLINE_MANIFEST_SCHEMA||m.app_version!=='v2.19.56-R1B'||m.cache_version!==OFFLINE_CACHE)throw new Error('offline manifest incompatible');
